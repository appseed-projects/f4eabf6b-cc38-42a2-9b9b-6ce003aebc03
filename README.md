...
- Timestamp: `2022-06-17 20:36`
- Build ID: `f4eabf6b-cc38-42a2-9b9b-6ce003aebc03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f4eabf6b-cc38-42a2-9b9b-6ce003aebc03.git
$ cd f4eabf6b-cc38-42a2-9b9b-6ce003aebc03
```
